...
(0, vitest_1.describe)('E2E: Protected Routes', () => {
    let app;
    ...
    (0, vitest_1.describe)('exact scope permissions', () => {
        (0, vitest_1.it)('requires x-user-id and permission with exact scope', async () => {
            // Create test user
            ...
            (0, vitest_1.expect)(JSON.parse(response.payload)).toEqual({ message: 'exact scope test passed' });
        });
    });
    (0, vitest_1.describe)('global scope permissions', () => {
        (0, vitest_1.it)('enforces global scope requirement', async () => {
            // Create test user
            const user = await app.userService.createUser({
            ...
            (0, vitest_1.expect)(response.statusCode).toBe(200);
            (0, vitest_1.expect)(JSON.parse(response.payload)).toEqual({ message: 'global scope test passed' });
        });
    });
    (0, vitest_1.describe)('type-wide scope permissions', () => {
        (0, vitest_1.it)('enforces type-wide scope requirement', async () => {
            // Create test user
            const user = await app.userService.createUser({
            ...
            (0, vitest_1.expect)(response.statusCode).toBe(200);
            (0, vitest_1.expect)(JSON.parse(response.payload)).toEqual({ message: 'type-wide scope test passed' });
        });
    });
    (0, vitest_1.describe)('mixed scope requirements', () => {
        (0, vitest_1.it)('handles global permission without context information', async () => {
            // Create test user
            const user = await app.userService.createUser({
            ...
            (0, vitest_1.expect)(response.statusCode).toBe(200);
            (0, vitest_1.expect)(JSON.parse(response.payload)).toEqual({
                message: 'mixed scope test passed'
            });
        });
    });
    (0, vitest_1.describe)('wildcard permissions', () => {
        (0, vitest_1.it)('handles wildcard permissions in routes', async () => {
            // Create test user
            const user = await app.userService.createUser({
            ...
            (0, vitest_1.expect)(response.statusCode).toBe(200);
            (0, vitest_1.expect)(JSON.parse(response.payload)).toEqual({ message: 'wildcard test passed' });
        });
    });
    (0, vitest_1.describe)('error handling', () => {
        (0, vitest_1.it)('handles invalid context types', async () => {
            // Create test user
            const user = await app.userService.createUser({
        ...
        (0, vitest_1.it)('handles missing user ID', async () => {
            // Register permission in the registry
            app.permissionRegistry.register({
